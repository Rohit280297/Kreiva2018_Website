...
class Home extends React.Component{
  ...
  toggleMenuHandler = () =>{
    this.setState({menuOpen:!this.state.menuOpen},()=>console.log(this.state.menuOpen));
  }
  render(){
    return (
      <div className="Home container-fluid">
          <img id="MainLogo" src={Logo} alt="Logo"/>
          <img id="Sidebar" src={MenuBar} alt="Logo" onClick={this.toggleMenuHandler}/>
              ...
              <div className="LinksSection">
                    <div className="col-lg-6 col-md-12 col-sm-12">
                        <div  id="Social_Home" >
                            ...
                            | Organized By<img id ="iiitv"src={IIITV} alt="IIITV"/>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-12 col-sm-12">
                      <div  id="Date_Home">
